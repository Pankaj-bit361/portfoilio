...
const Skills = () => {
  return (
    <Box  id = 'skills'>
      ...
      <Heading mt = '90px' color = 'rgb(0, 255, 162);' fontSize={35}><Text as = 'span' color = 'black'>Technical</Text> Skills</Heading>

      <SimpleGrid  columns = {{base : '2','529px' : '3','848px':'4'}} spacing={'20px'} mt = '50px' >

              { Tech_Stack.map((el,i) => { 
              
                  return <GridItem  key = {Math.random()} className="skills-card" border ="3px solid black" borderRadius={'20px'} >
