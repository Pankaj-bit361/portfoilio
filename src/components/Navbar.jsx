  ...
  return (
    ...
    <Box zIndex={'3'}  minW = '280px'  mb = '20px' boxShadow={'2px 2px 5px black'} position={'sticky'} top = '0' bg = 'black' color = 'white' as = 'nav' id="nav-menu" p = '2'>
        ...
        <HStack m = 'auto' w ={{base : '95%','587px' : '90%', '1120px' : '80%'}} justify = 'space-between'>
              ...
              <IconButton size = {['sm','md']} mr = '5px' display = {{base : 'block','836px' : 'none'}} _hover = {{background : 'rgb(14, 60, 96);'}} bg = 'black;' onClick = {onOpen} variant = 'none' icon = {<HamburgerIcon/>}></IconButton>

              <Image _hover = {{cursor : 'pointer'}} w = '40px' src = 'Pankajlogo.png'></Image>
